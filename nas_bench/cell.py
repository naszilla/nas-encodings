...
from nas_bench.distances import *
from nas_bench.sample_random import *
from nas_bench.encodings import *
from nas_bench.mutations import *
...
class Cell:
    ...
    def encode(self, predictor_encoding, cutoff=None):
